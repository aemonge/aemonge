...
{%
	\begin{minipage}{\dimexpr\textwidth-2\fboxsep\relax}
		...
		% Origen Experience
        \noindent\uline{\makebox[\textwidth][l]{\textbf{Principal Python Engineer \hfill Origen (2024-2025)}}} \\
...
{%  % Same background as Backend Engineer
    ...
    % Freelance Experience
        \noindent\uline{\makebox[\textwidth][l]{\textbf{Web Developer (Freelance) \hfill Madrid, Spain (2008-2013)}}} \\
        \vspace{0.1cm} \hspace{0.2cm}
