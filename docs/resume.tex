...
% Title Section
\noindent
{\Large\fontfamily{pag}\selectfont\color{darkblue} CTO, Software Architect, and Framework-Less Engineering Leader}

\vspace{0.2cm}
{\fontfamily{pag}\selectfont\color{darkblue} Language-agnostic systems design | Architecture-first execution}
\vspace{0.3cm}
...
\begin{minipage}[t]{0.7\textwidth}
	...
	Seasoned \textbf{software architect} with 15+ years of experience designing robust systems
	across financial services, SaaS products, and AI-driven platforms. As \textbf{CTO at Ultrai}, I
	lead architecture, engineering delivery, hiring, infrastructure, and security while remaining
	hands-on in implementation and technical spikes. I bridge \textbf{DevOps}, databases, and
	system design while prioritizing craftsmanship and elegant solutions in every project.
	\vspace{0.55cm}

	I focus on \textbf{framework-less engineering} where possible, using strong design principles,
	clear boundaries, and stateless patterns to keep systems maintainable over time.
	My career demonstrates consistent adaptation across stacks and domains, selecting each
	language pragmatically to maximize reliability, maintainability, and delivery speed.
	\vspace{0.55cm}
...
\begin{minipage}{\textwidth}
	...
	{\small\bfseries\color{darkblue}\fontfamily{pag}\selectfont - CTO, Software Architect, and Mentor}
	\vspace{0.3cm}

	Executive and hands-on leadership across architecture, delivery, and platform reliability. These are the core roles that define my recent trajectory:

	\vspace{0.35cm}
	\begin{minipage}{0.48\textwidth}
		\noindent\textbf{CTO - Technology Director @ Ultrai}

		Lead architecture and engineering execution for a financial services startup while remaining deeply hands-on (70\% coding/spikes, 30\% leadership).

		\vspace{0.3cm}
		\noindent\textbf{Senior Python Software Engineer @ Origen AI}

		Led platform evolution and productionization of AI services, including compliance-critical delivery and resilient workflow architecture.
	\end{minipage}
	\hfill
	\begin{minipage}{0.48\textwidth}
		\noindent\textbf{Engineering Manager @ Lavanda}

		Led two squads through delivery and technical debt reduction, balancing execution quality with business outcomes.

		\vspace{0.3cm}
		\noindent\textbf{Technical Lead @ Santander Global Tech}

		Led international squads and large-scale banking modernization with API-first and event-driven patterns.
...
\experiencebreak
% Ultrai Experience
\noindent\uline{\makebox[\textwidth][l]{\textbf{CTO - Technology Director \hfill Ultrai (Apr 2025-Present)}}} \\
\vspace{0.1cm} \hspace{0.2cm}
{\small\textit{Software Architecture, Monolith Design, Functional Programming Principles, Python, Rust, PostgreSQL, GitLab, Infisical, Authelia, NGINX, VictoriaLogs, Mattermost, Self-hosted Infrastructure, OWASP}}

At Ultrai, I lead technology execution end-to-end for a financial services startup while staying deeply hands-on (70\% coding/spikes, 30\% leadership). I own architecture, delivery, hiring, infrastructure, and security while co-driving roadmap and sprint planning.

\vspace{0.2cm}
\begin{itemize}[label=\textcolor{darkblue}{\textbullet}, leftmargin=*, nosep]
	\item Built a new chatbot platform from scratch and enabled a product pivot to a dashboard-centric offering
	\item Designed a flexible monolith architecture that supported fast iteration without sacrificing stability or testability
	\item Introduced Rust for performance-critical components and enforced strict typing with stateless design practices
	\item Implemented secure PostgreSQL patterns with security definer functions to prevent unrestricted SQL access from the application layer
	\item Established and operated a fully self-hosted open-source stack (GitLab, Infisical, Authelia, NGINX, VictoriaLogs, Mattermost) with OWASP-aligned security practices
\end{itemize}
...
\experiencebreak
% Bonial Experience
\noindent\uline{\makebox[\textwidth][l]{\textbf{Principal Frontend Engineer \hfill Bonial / Kaufda.de (2016-2017)}}} \\
\vspace{0.1cm} \hspace{0.2cm}
