...
\hypersetup{
    pdftitle={Andres Monge - CV - English},
...
\draw[fill=darkblue!80!background, rounded corners=5pt] (0,2) rectangle (6.5,4);
\draw[fill=red!80!background, rounded corners=5pt] (4.5,0) rectangle (6.5,4);
...
\node[anchor=north west, align=left] at (0, -0.5) {
    ...
    \textcolor{blue!80!background}{$\bullet$ 40\% Feature development and bugs fixing}\\
    \textcolor{red!80!background}{$\bullet$ 20\% Tasks definition, refinment and planning}
};
\end{tikzpicture}
...
\vfill
\hfill\footnotesize{Page \thepage{} of \pageref{LastPage}}
